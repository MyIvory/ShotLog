...
class _VideoPlayerOverlayState extends State<VideoPlayerOverlay> {
  ...
  static const _kAutoHideDuration = Duration(seconds: 3);
  ...
  void _resetHideTimer() {
    ...
    _hideTimer = Timer(_kAutoHideDuration, () {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: Listener(
        ...
        onPointerDown: (_) { if (_controlsVisible) _resetHideTimer(); },
        child: Stack(
          children: [
                              ...
                              child: Container(
                                ...
                                child: const Center(
                                  child: Icon(Icons.west,
                                      color: Color(0xFFF0EAE5), size: 18),
                                ),
                              ),
                            ),
                          ],
